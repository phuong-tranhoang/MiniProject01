...
public:
  ...
  /**===================================================
   *
   * Description: Get shuffle manager for UI display
   *
   * @param {none}
   * @returns {const ShuffleManager&} reference to shuffle manager
   */
  const ShuffleManager &getShuffleManager() const;
  /**===================================================
   *
  ...
  /**===================================================
   *
   * Description: Clear library and all queues
   *
   * @param {none}
   * @returns {none}
   */
  ...
  /**===================================================
   *
   * Description: Add all songs from an artist to queue
   *
   * @param {const std::string&} artistName - Artist name
   * @returns {size_t} - Number of songs added
   */
  size_t addArtistToQueue(const std::string &artistName);
};
